...
void ASSupervisor::can_callback(const driverless_msgs::msg::Can msg) {
...
void ASSupervisor::velocity_callback(const std_msgs::msg::Float32 msg) {
    this->last_velocity = msg.data;
    this->DVL_drivingDynamics1._fields.speed_actual = (int8_t)msg.data;
}

void ASSupervisor::steering_angle_callback(const std_msgs::msg::Float32 msg) {
    this->last_steering_angle = msg.data;
    this->DVL_drivingDynamics1._fields.steering_angle_actual = (int8_t)msg.data;
    this->run_fsm();
}

void ASSupervisor::control_callback(const ackermann_msgs::msg::AckermannDriveStamped msg) {
...
void ASSupervisor::lap_counter_callback(const std_msgs::msg::UInt8 msg) {
    this->ros_state.lap_count = msg.data;
    this->DVL_systemStatus._fields.lap_counter = msg.data;
}

void ASSupervisor::steering_state_callback(const std_msgs::msg::Bool msg) { this->ros_state.navigation_ready = msg.data; }

void ASSupervisor::shutdown_callback(const driverless_msgs::msg::Shutdown msg) {
