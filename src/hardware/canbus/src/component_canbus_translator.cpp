...
CANTranslator::CANTranslator(const rclcpp::NodeOptions &options)
    ...
    steer_cb_group_ = this->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);

    auto sub_opt = rclcpp::SubscriptionOptions();
    sub_opt.callback_group = sub_cb_group_;

    auto steer_opt = rclcpp::SubscriptionOptions();
    steer_opt.callback_group = steer_cb_group_;
