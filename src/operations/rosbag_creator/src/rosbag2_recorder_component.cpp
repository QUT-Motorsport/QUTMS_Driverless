...
: Node("rosbag2_recorder_component", options)
{
  ...
  is_recording_srv_ = this->create_service<driverless_msgs::srv::IsRecording>(
    ...
    std::bind(
      &Rosbag2RecorderComponent::handle_is_recording,
      this,
      std::placeholders::_1,
      std::placeholders::_2));
...
void Rosbag2RecorderComponent::handle_is_recording(
  const std::shared_ptr<driverless_msgs::srv::IsRecording::Request>,
