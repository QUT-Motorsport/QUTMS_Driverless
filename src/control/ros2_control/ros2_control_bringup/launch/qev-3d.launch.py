...
def generate_launch_description():
    ...
    robot_controller_names = ["steering_pid_controller", "drive_pid_controller", "ackermann_steering_controller"]
    controller_spawner_args = ["-c", "/controller_manager", "--activate-as-group"]
    controller_spawner_args.extend(robot_controller_names)
