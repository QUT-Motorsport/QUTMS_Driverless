...
def launch_setup(context, *args, **kwargs):
    ...
    # Process URDF xacro with hardware_interface='stepper'
    ...
    controllers_file = os.path.join(
        get_package_share_directory("ros2_control_bringup"), "config", "test_controllers.yaml"
    )
    ...
    # Spawner for steering position controller
