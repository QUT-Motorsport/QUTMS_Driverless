...
#ifndef QEV_ROS2_CONTROL_HARDWARE_INTERFACE_HPP_
#define QEV_ROS2_CONTROL_HARDWARE_INTERFACE_HPP_
...
class QevHardwareInterface : public hardware_interface::SystemInterface {
    struct Config {
   ...
   public:
    RCLCPP_SHARED_PTR_DEFINITIONS(QevHardwareInterface);
