...
def get_ground_plane(point_cloud):
    ...
    ground_plane = line_extraction.extract_lines(segments_bins_prototype, NUM_SEGMENTS, NUM_BINS)
...
def main(point_cloud, _visualise, _display, _save, benchmark):
    init_constants()
    if benchmark:
        ...
        if VISUALISE:
            FIGURES_DIR = "/home/developer/datasets/figures/"
            vis.init(point_cloud, DELTA_ALPHA, LIDAR_RANGE, BIN_SIZE, SAVE, FIGURES_DIR)
