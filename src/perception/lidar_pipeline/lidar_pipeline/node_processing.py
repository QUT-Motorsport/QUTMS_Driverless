...
from .scripts.ground_plane_estimation import lidar_init, lidar_main
...
class LidarProcessing(Node):
    def __init__(self, pc2_topic: str, visualise: bool, display: bool, max_range: int):
        ...
        self.pcl_subscription = self.create_subscription(PointCloud2, pc2_topic, self.callback, 10)
