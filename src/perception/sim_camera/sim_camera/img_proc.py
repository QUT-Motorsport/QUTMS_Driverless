...
def cam_main(frame, display=False):
    ...
    cv2.rectangle(
        big_blue_mask,
        (big_blue_cone[-2], big_blue_cone[-1]),
        (big_blue_cone[-2] + big_blue_cone[0], big_blue_cone[-1] + big_blue_cone[1]),
        1,
        -1,
    )
    ...
    v_off = 5
    snip = img[
        big_blue_cone[-1] - v_off : big_blue_cone[-1] + big_blue_cone[1] + v_off,
        big_blue_cone[-2] - h_off : big_blue_cone[-2] + big_blue_cone[0] + h_off,
        :,
    ]
